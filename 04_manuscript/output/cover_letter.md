...
4. **Open-access pipeline:** Uniquely, our entire analysis is built on freely accessible data sources and the complete pipeline---from data collection through manuscript generation---is publicly available on GitHub. This enables any researcher, regardless of institutional affiliation, to reproduce or update the analysis every six months.

5. **Urology sub-analysis:** We provide the first dedicated analysis of LLM applications in urology simulation, identifying the absence of any published work combining LLMs with simulation boot camps as a significant research gap.

This manuscript forms part of a broader research programme examining LLM integration in healthcare simulation, which includes a completed Delphi consensus study, a scoping review, and platform evaluation work. The bibliometric analysis presented here provides the landscape-level perspective that contextualises these companion studies.

We believe this work will be of significant interest to your readership, particularly those working in medical education, simulation-based training, and the application of artificial intelligence in healthcare education.

This manuscript has not been published or submitted elsewhere. All authors have approved the submission and declare no competing interests.
...
**Corresponding Author:** Shekhar [Surname]
Email: [shekhar.email@institution.ac.uk]
